...
import { getProfileByUsername, getUserPosts, updateProfile } from '@/server/actions/profile.action'
...
interface ProfilePageComponentPropType {
...
const ProfilePageComponent = ({user, posts, likedPosts, isFollowing: initialIsFollowing}: ProfilePageComponentPropType) => {
            ...
            <CardContent className="pt-6">
              <div className="flex flex-col items-center text-center">
                ...
                {!currentUser ? (
                  ...
                  <Button className="w-full mt-4" onClick={() => setShowDialog(true)}>
